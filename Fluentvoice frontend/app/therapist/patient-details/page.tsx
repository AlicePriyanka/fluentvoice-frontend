  ...
  if (!id) {
    return (
      <div className="max-w-5xl mx-auto">
        <Link href="/therapist/patients" className="inline-flex items-center gap-1.5 text-sm text-[#64748B] hover:text-[var(--color-navy)]">
          <ChevronLeft className="w-4 h-4" /> Back
        </Link>
        <p className="mt-8 text-center text-[#9CA3AF]">No patient ID provided.</p>
      </div>
    );
  }
